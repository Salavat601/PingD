...
class ContactsPage extends Component {
  ...
  render() {
    ...
    if (this.state.viewing) {
      let shownContact = contacts.find(
        contact => contact.contactId === this.state.viewing,
      );
      if (shownContact)
        contactView = (
          <ContactView contact={shownContact} reset={this.resetContact} />
        );
    }
    ...
    return (
      <View style={styles.container}>
        ...
        />
        <TouchableOpacity
          onPress={() => this.props.addMoreContacts()}

...
export class Contact {
	constructor(props) {
		let { info, contactId, firstName, lastName, phoneNumber, thumbnail, priority, contactMethod, lastContact, notes } = props
		if (info) {
			...
			if (info.phoneNumbers && info.phoneNumbers.length > 0) {
				...
				this.phoneNumber = (phoneNumbers && phoneNumbers.length > 0) ? phoneNumbers[0] : ""
			}
